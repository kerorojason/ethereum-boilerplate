  ...
  return (
    <>
      <div style={styles.NFTs}>
        {collectionAddress
          ? // Show NFTs of selected collection
            NFTTokenIds &&
              ...
              <Card
                ...
                actions={[
                  <Tooltip
                    ...
                    key="View this collection"
                  >
                    <RightCircleOutlined
                      onClick={() => setCollectionAddress(collection.addrs)}
                    />
                  </Tooltip>,
                ]}
                style={{ width: 240, border: "2px solid #e7eaf3" }}
