...
import { Input, Card, Image, Tooltip, Modal } from "antd";
...
const LIST_ITEM_FUNCTION_NAME = "createMarketItem";
...
function NFTBalance() {
  ...
  async function list(nft, price) {
    setLoading(true);
    const p = price * ("1e" + 18);
    const ops = {
      contractAddress: marketAddress,
      functionName: LIST_ITEM_FUNCTION_NAME,
      abi: contractAbi,
      params: {
